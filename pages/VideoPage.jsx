...
function VideoPage() {
  ...
  async function submitComment() {
    ...
    await axios
      .post(`${apiUrl}/comment/${id.id}`, formData, {
        headers: {
  ...
  async function subscribe() {
    const url = !isSub
      ? `${apiUrl}/channel/unsubscribe/${channelInfo._id}`
      : `${apiUrl}/channel/subscribe/${channelInfo._id}`;
  ...
  async function AddLike() {
    await axios
      .put(`${apiUrl}/video/like/${id.id}`, null, {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("token")}`,
          Name: "Omkarg",
        },
  ...
  async function AddDisLike() {
    await axios
      .put(`${apiUrl}/video/dislike/${id.id}`, null, {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("token")}`,
          Name: "Omkarg",
        },
  ...
  async function handleEdit(id) {
    ...
    await axios
      .put(`${apiUrl}/comment/${id}`, formData, {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("token")}`,
        },
      })
